...
const Testimonial = () => {
    ...
    useEffect(() => {
        fetch('https://bistro-boss-server-seven-phi.vercel.app/reviews')
            .then(res => res.json())
                    ...
                    >
                        <div className="flex flex-col items-center mx-24 my-16">
                            <Rating
                                ...
                                readOnly
                            />
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none" className="my-12">
                            ...
                            <h2 className="text-2xl font-medium text-[#CD9003]">{review.name}</h2>
                        </div>
                    </SwiperSlide>)
                }
